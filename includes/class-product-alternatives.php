...
class Product_Alternatives
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Product_Alternatives_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'product-alternatives';
	 ...
	 *
	 * - Product_Alternatives_Loader. Orchestrates the hooks of the plugin.
	 * - Product_Alternatives_i18n. Defines internationalization functionality.
	 * - Product_Alternatives_Admin. Defines all hooks for the admin area.
	 * - Product_Alternatives_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Product_Alternatives_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks()
	{
		...
		$this->loader->add_filter('woocommerce_add_to_cart_validation', $plugin_public, 'limit_quantity_and_prevent_duplicates', 10, 2);
		//$this->loader->add_action( 'woocommerce_before_cart', 'display_cart_notices', 10 );
		$this->loader->add_filter( 'woocommerce_before_cart',$plugin_public,  'display_cart_notices', 10 );
